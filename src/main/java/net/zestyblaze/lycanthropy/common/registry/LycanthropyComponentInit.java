...
import net.zestyblaze.lycanthropy.common.component.LycanthropyPlayerAbilityComponent;
...
public class LycanthropyComponentInit implements EntityComponentInitializer {
    ...
    public static final ComponentKey<LycanthropyPlayerAbilityComponent> WEREWOLF_ABILITY = ComponentRegistry.getOrCreate(new Identifier(Lycanthropy.MODID, "werewolf_ability"), LycanthropyPlayerAbilityComponent.class);
    ...
    public void registerEntityComponentFactories(EntityComponentFactoryRegistry registry) {
        ...
        registry.registerForPlayers(WEREWOLF_ABILITY, LycanthropyPlayerAbilityComponent::new, RespawnCopyStrategy.ALWAYS_COPY);
