...
import net.zestyblaze.lycanthropy.common.statuseffect.EmptyStatusEffect;
...
public class LycanthropyStatusEffectsInit {
    private static final Map<StatusEffect, Identifier> STATUS_EFFECTS = new LinkedHashMap<>();
        public static final StatusEffect BLEEDING = register("bleeding", new EmptyStatusEffect(StatusEffectCategory.HARMFUL, 0xF50033));
